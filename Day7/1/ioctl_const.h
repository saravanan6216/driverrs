#ifndef _BITSILICA_CHAR_DEVICE_H_
#define _BITSILICA_CHAR_DEVICE_H_
...
/* BITSILICA_FILL_ZERO: to fill our character array with zeros
...
*/
#define BITSILICA_FILL_ZERO		_IO( BITSILICA_MAGIC, 1 )

/* BITSILICA_FILL_ZERO: to fill our character array with a character
   As we can see there is not data transfer. The moment
   our driver gets this command, it executes the following
   for loop
...
*/
#define BITSILICA_FILL_CHAR		_IOW( BITSILICA_MAGIC, 2, char )

/* BITSILICA_SET_SIZE: to set the size of the character array */

#define BITSILICA_SET_SIZE		_IOW( BITSILICA_MAGIC, 3, uint )

/* BITSILICA_GET_SIZE: to get the size of the character array */
#define BITSILICA_GET_SIZE		_IOR( BITSILICA_MAGIC, 4, uint )

#define BITSILICA_MAX_CMDS		4

#endif /* _BITSILICA_CHAR_DEVICE_H_ */
